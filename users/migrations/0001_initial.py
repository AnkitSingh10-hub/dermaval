    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, max_length=254, null=True, validators=[django.core.validators.MinLengthValidator(3)], verbose_name='email address')),
                ...
                ('avatar', models.ImageField(blank=True, null=True, upload_to='avatar', verbose_name='Image')),
